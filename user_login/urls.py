...
urlpatterns = [
    ...
    path('account/myprofile',views.myprofile, name='myprofile'),
    ...
    path('nogroup_account/ngmyprofile',views.myprofile, name='ngmyprofile'),
    path('nogroup_account/ngchangepassword',views.changepassword, name='ngchangepassword'),
